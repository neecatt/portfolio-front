...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({ experiences, projects }) => (
  <Box bg="whiteAlpha.50" backdropFilter="blur(10px)" borderRadius="md" p={6} border="1px solid" borderColor="whiteAlpha.200">
    ...
    <Box mt={8}>
      ...
      <Flex gap={4} flexWrap="wrap">
        <Box p={4} bg="whiteAlpha.100" borderRadius="md" flex="1" minW="200px" border="1px solid" borderColor="whiteAlpha.200">
